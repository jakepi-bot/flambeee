...
- Cinder offline progress / catch-up on return (highest-value future story; touches the fight economy and balance, so it needs a Story 031-style decision record before any code)
